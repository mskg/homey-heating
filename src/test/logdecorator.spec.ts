import { trycatchlog, asynctrycatchlog } from "../app/services/log";
...
//     await new Test(true).testAsyncThrow();
//     console.log(await new Test(true).testGetAsync);

//     await new Test(false).testAsyncThrow();
//     console.log(await new Test(false).testGetAsync);
// };